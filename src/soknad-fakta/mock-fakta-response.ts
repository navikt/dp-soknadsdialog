export const mockFakta = {
  "@event_name": "NySøknad",
  "@opprettet": "2022 - 02 - 14T10: 29: 35.883724",
  "@id": "14b0b84a - 428a - 42ab - ba45 - 4bfd378af434",
  søknad_uuid: "ece1eeef - 2a7a - 4b40 - a58f - c16f5984996a",
    ...
    },
    {
      ...
      templates: [
        ...
        },
        {
          ...
          type: "tekst",
          beskrivendeId:
            "faktum.arbeidsforhold - aarsak - til - avskjedigelse - fra - arbeidsgiver",
          roller: ["søker"],
        },
        {
          id: "8015",
